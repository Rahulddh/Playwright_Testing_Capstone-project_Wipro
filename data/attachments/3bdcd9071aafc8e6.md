...
- Name: checkout/checkout.spec.js >> Checkout And Order Module >> CHECKOUT-06 Verify cart button enabled
- Location: tests/checkout/checkout.spec.js:63:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:00:09 MST
      - text: .
