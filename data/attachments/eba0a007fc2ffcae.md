...
- Name: search/search.spec.js >> Product Module Tests >> SEARCH-13 Verify first product visible
- Location: tests/search/search.spec.js:139:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:01:37 MST
      - text: .
