...
- Name: shipping/shipping.spec.js >> Shipping Address Module >> SHIPPING-14 Verify cart button enabled
- Location: tests/shipping/shipping.spec.js:95:3
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:02:42 MST
      - text: .
