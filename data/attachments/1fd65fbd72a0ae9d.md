...
- Name: shipping/shipping.spec.js >> Shipping Address Module >> SHIPPING-16 Verify cart page url contains view cart
- Location: tests/shipping/shipping.spec.js:106:3
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:04:27 MST
      - text: .
