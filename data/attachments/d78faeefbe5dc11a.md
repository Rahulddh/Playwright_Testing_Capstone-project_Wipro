...
- Name: shipping/shipping.spec.js >> Shipping Address Module >> SHIPPING-04 Verify delivery address section locator created
- Location: tests/shipping/shipping.spec.js:43:3
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:06:28 MST
      - text: .
