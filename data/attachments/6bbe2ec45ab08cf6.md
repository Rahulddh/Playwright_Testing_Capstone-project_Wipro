...
- Name: checkout/checkout.spec.js >> Checkout And Order Module >> CHECKOUT-12 Verify body visible on products page
- Location: tests/checkout/checkout.spec.js:107:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:00:31 MST
      - text: .
