...
- Name: cart managment/cart.spec.js >> Cart Module Tests >> CART-05 Verify body visible on cart page
- Location: tests/cart managment/cart.spec.js:56:3
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 14:58:03 MST
      - text: .
