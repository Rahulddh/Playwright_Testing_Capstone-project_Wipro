...
- Name: search/search.spec.js >> Product Module Tests >> SEARCH-11 Verify Kids Category Visible
- Location: tests/search/search.spec.js:120:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:05:10 MST
      - text: .
