...
- Name: shipping/shipping.spec.js >> Shipping Address Module >> SHIPPING-13 Verify products button enabled
- Location: tests/shipping/shipping.spec.js:90:3
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:02:37 MST
      - text: .
