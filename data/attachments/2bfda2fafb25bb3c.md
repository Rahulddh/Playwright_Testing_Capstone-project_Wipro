...
- Name: search/search.spec.js >> Product Module Tests >> SEARCH-08 Verify Add to Cart VIsible
- Location: tests/search/search.spec.js:92:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:02:34 MST
      - text: .
