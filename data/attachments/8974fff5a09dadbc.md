...
- Name: checkout/checkout.spec.js >> Checkout And Order Module >> CHECKOUT-03 Verify footer visible
- Location: tests/checkout/checkout.spec.js:40:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 14:59:42 MST
      - text: .
