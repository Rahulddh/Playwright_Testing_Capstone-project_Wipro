...
- Name: cart managment/cart.spec.js >> Cart Module Tests >> CART-10 Verify current url contains automation exercise
- Location: tests/cart managment/cart.spec.js:95:3
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 14:59:16 MST
      - text: .
