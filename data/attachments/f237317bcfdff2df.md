...
- Name: Authentication/login.spec.js >> Login Tests >> LOGIN-04 invalid email formatrahul.com
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 14:37:56 MST
      - text: .
