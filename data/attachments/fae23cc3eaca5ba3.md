...
- Name: Authentication/signup.spec.js >> Signup Tests >> AUTH-01 Signup with valid data
- Location: tests/Authentication/signup.spec.js:11:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 14:51:16 MST
      - text: .
