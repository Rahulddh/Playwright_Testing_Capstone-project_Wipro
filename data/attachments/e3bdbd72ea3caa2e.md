...
- Name: checkout/checkout.spec.js >> Checkout And Order Module >> CHECKOUT-10 Verify cart page contains cart text
- Location: tests/checkout/checkout.spec.js:92:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:00:23 MST
      - text: .
