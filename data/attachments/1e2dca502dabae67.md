...
- Name: shipping/shipping.spec.js >> Shipping Address Module >> SHIPPING-18 Verify page title contains automation
- Location: tests/shipping/shipping.spec.js:117:3
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/login port 443 on Wednesday, 03-Jun-2026 15:02:54 MST
      - text: .
